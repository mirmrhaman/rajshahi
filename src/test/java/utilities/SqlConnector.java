...
public class SqlConnector {
    ...
    static String dbName = ReadConfigFiles.getPropertyValue("DbName");
    private static final String DbUrl = String.format("jdbc:postgresql://localhost:5432/%s", dbName);
    private static final String User = ReadConfigFiles.getPropertyValue("DBUser");
    private static final String Password = ReadConfigFiles.getPropertyValue("DbPassword");
    ...
    private static Connection connect() {
        ...
        try {
            ...
            LOGGER.error("SQL Connection: " + e.getMessage());
        }
        return conn;
    }
